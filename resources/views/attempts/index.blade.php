        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 bg-white border border-gray-200 rounded-xl shadow-sm">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('learn.index') }}"
                   class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Pergi ke Belajar
                </a>
            </div>
        </div>
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form action="{{ route('attempts.index') }}" method="GET">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                        <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Terapkan Filter</button>
